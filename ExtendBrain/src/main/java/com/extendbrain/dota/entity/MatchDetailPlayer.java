...
public class MatchDetailPlayer {
	...
	public void setGold_spend(int gold_spend) {
		this.gold_spend = gold_spend;
	}
	...
	public String toString() {
		return "MatchDetailPlayer [account_id=" + account_id + ", player_slot="
				+ player_slot + ", hero_id=" + hero_id + ", item_0=" + item_0
				+ ", item_1=" + item_1 + ", item_2=" + item_2 + ", item_3="
				+ item_3 + ", item_4=" + item_4 + ", item_5=" + item_5
				+ ", kills=" + kills + ", deaths=" + deaths + ", assists="
				+ assists + ", leaver_status=" + leaver_status + ", gold="
				+ gold + ", last_hits=" + last_hits + ", denies=" + denies
				+ ", gold_per_min=" + gold_per_min + ", xp_per_min="
				+ xp_per_min + ", gold_spend=" + gold_spend + ", hero_damage="
				+ hero_damage + ", tower_damage=" + tower_damage
				+ ", hero_healing=" + hero_healing + ", level=" + level
