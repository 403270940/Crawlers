...
public class Deal {
	...
	public String getDeal_roomtype() {
		return deal_roomtype;
	}

	public void setDeal_roomtype(String deal_roomtype) {
		this.deal_roomtype = deal_roomtype;
	}

	public String getDeal_roomtime() {
		return deal_roomtime;
	}

	public void setDeal_roomtime(String deal_roomtime) {
		this.deal_roomtime = deal_roomtime;
	}
	...
	public String toString() {
		return "Deal [webSite=" + webSite + ", deal_more_img=" + deal_more_img
				+ ", reservation=" + reservation + ", destination="
				+ destination + ", partner=" + partner + ", city_name="
				+ city_name + ", city_id=" + city_id + ", city_url=" + city_url
				+ ", deal_id=" + deal_id + ", deal_title=" + deal_title
				+ ", deal_rank=" + deal_rank + ", deal_url=" + deal_url
				+ ", deal_wap_url=" + deal_wap_url + ", deal_img=" + deal_img
				+ ", deal_cate_id=" + deal_cate_id + ", deal_cate=" + deal_cate
				+ ", deal_subcate_id=" + deal_subcate_id + ", deal_subcate="
				+ deal_subcate + ", deal_desc=" + deal_desc + ", value="
				+ value + ", price=" + price + ", rebate=" + rebate
				+ ", refund=" + refund + ", sales_min=" + sales_min
				...
				+ deal_phones + ", deal_roomtype=" + deal_roomtype
				+ ", deal_roomtime=" + deal_roomtime + ", coupon=" + coupon
				+ "]";
	}
